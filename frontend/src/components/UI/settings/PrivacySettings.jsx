  ...
  return (
    <div className="min-h-screen bg-[#fcfcfc] px-8 py-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl">
        <div className="bg-white rounded-lg p-4 flex items-center justify-between shadow">
          <div>
            <div className="font-semibold">Profile Visibility</div>
            <div className="text-xs text-gray-500">
              Show my profile in search result
            </div>
          </div>
          <input
            type="checkbox"
        ...
        <div className="bg-white rounded-lg p-4 flex items-center justify-between shadow">
          <div>
            <div className="font-semibold">Performance Cookies</div>
            <div className="text-xs text-gray-500">
              Allow us count visits in traffic source
            </div>
          </div>
          <input
            type="checkbox"
            checked={cookies}
            onChange={() => setCookies((v) => !v)}
            className="toggle-checkbox"
          />
        </div>
        <div className="bg-white rounded-lg p-4 flex items-center justify-between shadow">
          <div>
            ...
            <div className="text-xs text-gray-500">
              Enable/disable for important updates
            </div>
          </div>
          <input
            type="checkbox"
